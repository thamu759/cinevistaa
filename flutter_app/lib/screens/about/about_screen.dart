      ...
      body: ListView(
        ...
        children: [
          const Row(
            ...
            children: [
              Text('Thirai', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
              Text('Pedia', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w300, color: Color(0xFFE50914))),
            ],
          ),
          const SizedBox(height: 8),
          const Center(child: Text('Premium Film Critique & Reviews', style: TextStyle(color: Colors.white54))),
  ...
  Widget _section(String heading, String text) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(heading, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
          const SizedBox(height: 8),
