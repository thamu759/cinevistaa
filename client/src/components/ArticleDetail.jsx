  ...
  return (
    <div className="main-content" style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ marginBottom: '2rem' }}>
        <button className="btn-secondary" style={{ fontSize: '0.78rem', padding: '0.35rem 0.85rem' }} onClick={() => onNavigate('articles')}>
          ← Back to Articles
        </button>
      </div>
      <article>
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', marginBottom: '1rem' }}>
          ...
          <span style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>{article.date}</span>
          <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>· {article.readTime}</span>
        </div>
        <h1 style={{ fontSize: '2rem', lineHeight: 1.2, marginBottom: '0.75rem', fontWeight: 700 }}>{article.title}</h1>
        <p style={{ fontSize: '0.85rem', color: 'var(--color-text-muted)', marginBottom: '2rem' }}>By {article.author}</p>
        <div style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--color-text-main)' }}>
